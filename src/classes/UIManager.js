...
//             Object.values(this.stageManager.enemyGroups).forEach(group => {
//                 group.getChildren().forEach(enemy => {
//                     this.createEnemyHealthBar(enemy);
//                 });
    
//                 group.on('childAdded', (enemy) => {
//                     this.createEnemyHealthBar(enemy);
//                 });
//             });
//         }
...
//             const barWidth = this.scaleForDPI(50);
//             const barHeight = 5;
    
//             const bar = this.scene.add.rectangle(x, y, barWidth, barHeight, 0xff0000).setOrigin(0.5, 0.5).setDepth(10);
...
//             enemy.on('healthChanged', (newHealth, maxHealth) => {
//                 const healthPercentage = newHealth / maxHealth;
//                 this.updateEnemyHealthBar(healthBar, healthPercentage);
//             });
    
//             this.updateEnemyHealthBar(healthBar, enemy.health / enemy.maxHealth);
//         }
    
//         updateEnemyHealthBar(healthBar, healthPercentage) {
//             const newWidth = healthBar.bar.width * healthPercentage;
    
//             healthBar.bar.setAlpha(1);
    
//             this.scene.tweens.add({
//                 targets: healthBar.bar,
//                 width: newWidth,
//                 duration: 300,
//                 ease: 'Linear',
//                 onComplete: () => {
